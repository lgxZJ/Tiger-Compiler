...
#include "CXX_myTable.h"

extern "C"{

typedef char*	            myString;
typedef struct mySymbol_*   mySymbol;
 ...
 *	@remark	Invalid symbols are NULLs.
 */
bool MySymbol_InvalidSymbol(mySymbol symbol);

/**
 *  @brief  Check two symbols' equality.
 *  @param[in]  lhs One valid symbol.
 *  @param[in]  rhs One valid symbol.
 *  @return     If equals, return true; otherwise, return false;
 */
...
/**
 *	@brief	Make a new valid empty table to hold symbols.
 ...
 *	@param[in]	symbol	A valid symbol to enter.
