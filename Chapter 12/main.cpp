...
{   
    ...
    if (system(buf) == -1)
        return -1;
    sprintf(buf, "gcc -g -o ./tiger_rt_o.s ./tiger_rt_o.c -S -m32");
    if (system(buf) == -1)
        return -1;
    sprintf(buf, "as -g -o ./bin/output/tiger_rt_o.o ./tiger_rt_o.s --32");
    if (system(buf) == -1)
        return -1;
    for (int i = 1; i <= 22; ++i)
    {
        ...
        sprintf(buf, 
                ...
                " ./bin/output/tiger_rt.o ./bin/output/tiger_rt_o.o"
