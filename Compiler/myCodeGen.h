...
namespace lgxZJ
{
    ...
    private:
        ...
        void WriteProcBody(std::ofstream& outFile, mySymbol procName, IR_myStatement statements);
        ...
        void GenOneProcIns( mySymbol procName, IR_myStatement statements,
                            RA::RegisterMap* map, IS::Instructions* ins, int* localCount);
