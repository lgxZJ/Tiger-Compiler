...
void test_FrameallocateLocal_TwoConsecutiveCallsInSameFrame_OffsetDecrementFour(void)
{
    myFrame frame = Frame_newFrame((myLabel)NULL, NULL);
...
int main()
{
    ...
    CU_TestInfo tests[] = {
        ...
        { "", test_FrameallocateLocal_TwoConsecutiveCallsInSameFrame_OffsetDecrementFour },
