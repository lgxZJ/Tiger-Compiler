...
/// \brief      get variable entry's access field.
/// \param[in]  varEntry    the variable entry.
/// \return     an Trans_myAccess variable.
/// \remark     it's a checked runtime error to pass a invalid variable
///             entry into this function.
Trans_myAccess MyEnvironment_getVarAccess(myVarAndFuncEntry varEntry);
