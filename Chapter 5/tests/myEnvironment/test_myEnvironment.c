...
void test_makeVarEntry_ByDefault_MakeOneValidVarEntry(void)
{
    ...
    myVarAndFuncEntry entry = myEnvironment_makeVarEntry(fakeVarType);
...
void test_makeFuncEntry_ByDefault_MakeOneValidFuncEntry(void)
{
    ...
    myVarAndFuncEntry entry = myEnvironment_makeFuncEntry(fakeFormalTypes, fakeReturnType);
...
void test_addNewVarOrFunc_ByDefault_AddOne(void)
{
    ...
    myVarAndFuncEntry entry = myEnvironment_makeVarEntry(fakeType);
