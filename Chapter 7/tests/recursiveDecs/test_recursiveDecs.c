...
//  test global
static IR_myStatement g_stateResult = NULL;
...
void test_MySemanticDecsRecursive_LegalVars_ReturnTrue(void)
{
    ...
    bool result = MySemantic_Decs_Recursive(varDecs, &g_stateResult);
...
void test_MySemanticDecsRecursive_LegalRecursiveTypes_ReturnTrue(void)
{
    ...
    bool result = MySemantic_Decs_Recursive(typeDecs, &g_stateResult);
...
void test_MySemanticDecsRecursive_IllegalRecursiveTypes_ReturnFalse(void)
{
    ...
    bool resultOne = MySemantic_Decs_Recursive(typeDecsOne, &g_stateResult);
    bool resultTwo = MySemantic_Decs_Recursive(typeDecsTwo, &g_stateResult);
...
void test_MySemanticDecsRecursive_LegalRecursiveFuncs_ReturnTrue(void)
{
    ...
    bool result = MySemantic_Decs_Recursive(funcDecs, &g_stateResult);
