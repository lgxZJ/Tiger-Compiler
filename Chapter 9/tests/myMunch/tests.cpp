...
class MunchTest : public CppUnit::TestFixture
{
    public:
        ...
        CPPUNIT_TEST(testMunchExp_AndRightRegisterBinOperation_PutAdd);
        CPPUNIT_TEST(testMunchExp_AndRightConstBinOperation_PutAdd);
        ...
        CPPUNIT_TEST(testMunchExp_MultiplyRightConstBinOperation_PutIMul);
        CPPUNIT_TEST(testMunchExp_DivideRightRegisterBinOperation_PutIDiv);
        CPPUNIT_TEST(testMunchExp_DivideRightConstBinOperation_PutIDiv);
    ...
    public:
        ...
        void testMunchExp_BinOperation_ReturnLeftOperandReg()
        {
            ...
            myTemp resultTwo = Munch::Exp(
                IR_makeBinOperation(IR_And, IR_makeTemp(reg), IR_makeTemp(Temp_newTemp())));
            myTemp resultOne = Munch::Exp(
                IR_makeBinOperation(IR_And, IR_makeTemp(reg), IR_makeConst(2)));
        ...
        void testMunchExp_AndRightRegisterBinOperation_PutAdd()
        {
            testAndOrMinusOrXor_RightRegisterBinOperation_PutOne(IR_And, isAAIAdd);
        }

        void testMunchExp_AndRightConstBinOperation_PutAdd()
        {
            testAndOrMinusOrXor_RightConstBinOperation_PutOne(IR_And, isAAIAdd);
        }
        ...
        void testMultiplyOrDivide_RightConstBinOperation_PutOne(
            IR_BinOperator op, bool(checkFunc)(shared_ptr<AAI> ptr))
        {
            myTemp leftReg = Temp_newTemp();
            int constValue = 5643257;

            Munch::Exp(IR_makeBinOperation(
                op, IR_makeTemp(leftReg), IR_makeConst(constValue)));
            ...
            CPPUNIT_ASSERT_EQUAL(
                true,
                isAAIContainsConst(result.at(1), constValue));
        }
        ...
        void testMunchExp_MultiplyRightConstBinOperation_PutIMul()
        {
            testMultiplyOrDivide_RightConstBinOperation_PutOne(IR_Multiply, isAAIIMul);
        }
        ...
        void testMunchExp_DivideRightConstBinOperation_PutIDiv()
        {
            testMultiplyOrDivide_RightConstBinOperation_PutOne(IR_Divide, isAAIIDiv);
        }
        ...
        void testMunchExp_Call_PutCall()
        {
            ...
            CPPUNIT_ASSERT_EQUAL(true, isAAIContainsString(result.at(0), MySymbol_GetName(funcLabel)));
            CPPUNIT_ASSERT_EQUAL(
                true,
